...
const Contact: React.FC = () => {
  ...
  const mapCardRef = useInView();

  return (
    <div className="min-h-screen bg-slate-50">
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div ref={leftRef as React.RefObject<HTMLDivElement>} className="reveal-section space-y-12">
            <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="reveal-item bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-4 hover:-translate-y-1 transition-transform duration-200" style={{ animationDelay: '0ms' }}>
              ...
              <div className="reveal-item bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-4 hover:-translate-y-1 transition-transform duration-200" style={{ animationDelay: '60ms' }}>
                <div className="bg-red-600/10 w-12 h-12 rounded-xl flex items-center justify-center text-red-600">
                  <Mail size={24} />
                </div>
              ...
              <div className="reveal-item bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-4 hover:-translate-y-1 transition-transform duration-200" style={{ animationDelay: '120ms' }}>
                <div className="bg-red-600/10 w-12 h-12 rounded-xl flex items-center justify-center text-red-600">
                  <MapPin size={24} />
                </div>
              ...
              <div className="reveal-item bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-4 hover:-translate-y-1 transition-transform duration-200" style={{ animationDelay: '180ms' }}>
                <div className="bg-red-600/10 w-12 h-12 rounded-xl flex items-center justify-center text-red-600">
          ...
          <div ref={formRef as React.RefObject<HTMLDivElement>} className="animate-fade-slide-up bg-white rounded-[3rem] p-12 shadow-2xl border border-slate-100 h-fit">
      ...
      <section className="h-[500px] w-full bg-slate-200 relative">
        ...
        <div className="relative z-10 h-full flex items-center justify-center p-4">
           <div ref={mapCardRef as React.RefObject<HTMLDivElement>} className="animate-fade-slide-up bg-white p-8 rounded-3xl shadow-2xl border border-slate-100 max-w-md text-center space-y-4">
